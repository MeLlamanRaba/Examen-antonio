...
public class HuevoSorpresaAntonioRabanedaLopez {
...
public HuevoSorpresaAntonioRabanedaLopez(){}


public HuevoSorpresaAntonioRabanedaLopez(int unidades, double precio, String sorpresa, double precio_max){
    this.unidades=unidades;
    this.precio=precio;
    this.sorpresa=sorpresa;
    this.precio_max=precio_max;
...
public void sacarHuevosSorpresas(int unidades, double dinero) throws java.lang.Exception{
        sacarHuevosSorpresas(unidades, dinero, unidades);
}

    public void sacarHuevosSorpresas(int unidades, double dinero, int sorpresa) throws Exception {
        if (dinero <= 0) {
